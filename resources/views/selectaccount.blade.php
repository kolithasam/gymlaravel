...
<div class="split left" >
  <div class="centered">
    ...
    <h2 style="color: white;">Trainner</h2>
    <p style="color: white;">Before you register here you must be register as a Client</p>
    
    <center><button class="btn more" id="button" style="vertical-align:middle"><a href="/coach" style="color: white;">   Register Now   </a></button></center>
  </div>
</div>

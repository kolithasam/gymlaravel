...
<body>
    ...
    <main class="main">
        <div class="container">
            <div class="page-header">
                ...
                <h1 style="color:#E0C11E;">Hired Coaches List</h1>
                <br>
    ...
    <center> <img src="/Images/coach.jpg" title="Store" alt="Store" style="height: 600px;" width="1000px" class="img-responsive" /></center>
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped">
                        ...
                        <th style="background: #1A908F;">
                            <h3 style="color: white;">COACH EMAIL</h3>
                        </th>


                        <th style="background: #1A908F;">
                            <h3 style="color: white;">VIEW SHEDULE </h3>
                        </th>
                        <th style="background: #1A908F;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <h4>{{$client->coach_email}}</h4>
                            </td>


                            <td>
                                <center><button class="btn more" id="button" style="vertical-align:middle"><a href="clientviewshedule/{{$client->id}}" style="color: gainsboro;">View</a></button></center>
                            </td>

                            <td>
                                <center><button class="btn more" id="buttons" style="vertical-align:middle"><a href="chat/delete/{{$client->id}}" style="color: gainsboro;">Delete</a></button></center>
